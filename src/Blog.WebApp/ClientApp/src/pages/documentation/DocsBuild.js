                ...
                <Card>
                    <Card.Body>
                        <article>
                            ...
                            <p className="fs-5 fw-light">Learn the commands that will help you work with Volt React
                                Dashboard and the commands that can build the final production version of your app.</p>
