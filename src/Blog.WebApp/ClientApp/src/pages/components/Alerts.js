...
import {Alert, Button, Col, Container, Row} from '@themesberg/react-bootstrap';
        ...
        <article>
            <Container className="px-0">
                ...
                <Documentation
                    title="Example"
                    description={
                        <p>The <code>&#x3C;Alert&#x3E;</code> component can be used to show your users error, success,
                            informational or warning messages. Use component properties such
                            as <code>variant="primary</code> or <code>variant="secondary"</code> to use the colors from
                            the Sass variables:</p>
                    }
                    scope={{Alert}}
  ...
  <Alert variant="dark">
    A simple dark alert — check it out!
                ...
                <Documentation
                    ...
                    description={
                        <p>The <code>&#x3C;Alert&#x3E;</code> component can be used to create an alert component that
                            can be closed by clicking on the close icon by adding
                            the <code>show</code> and <code>onClose</code> properties. Additionally, you can also use
                            the <code>&#x3C;FontAwesomeIcon&#x3E;</code> component to add an icon inside the alert
                            component.</p>
                    }
