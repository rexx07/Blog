...
import {Breadcrumb, Col, Container, Row} from '@themesberg/react-bootstrap';
        ...
        <article>
            <Container className="px-0">
                ...
                <Documentation
                    title="Example"
                    description={
                        <p>Use the <code>&#x3C;Breadcrumb&#x3E;</code> component to show a clear navigational hierarchy
                            for your users, wherever they may be on a given page. Using
                            the <code>variant</code> modifier props you can update the color of the component.</p>
                    }
    ...
    <Breadcrumb listProps={{ className: "breadcrumb-info breadcrumb-text-light text-white" }}>
        ...
        <Breadcrumb.Item active>Data</Breadcrumb.Item>
                ...
                <Documentation
                    ...
                    description={
                        <p>In order to make the <code>&#x3C;Breadcrumb&#x3E;</code> component transparent, all you need
                            to do is add the <code>breadcrumb-transparent</code> modifier class to the parent component.
                        </p>
                    }
                    scope={{Row, Col, Breadcrumb}}
                    imports={`import { Breadcrumb } from '@themesberg/react-bootstrap';`}
