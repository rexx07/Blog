    ...
    <article>
        <Container className="px-0">
            ...
            <Documentation
                title="Example"
                description={
                    <p>The <code>&#x3C;Nav&#x3E;</code> component should be used for app navigation, such as for the
                        navigation bar, a secondary menu, or other. The <code>&#x3C;Nav.Link&#x3E;</code> component can
                        be attributed with the location of the link.</p>
                }
                scope={{Nav, Row, Col}}
        ...
        <Nav.Link eventKey="messages" href="#" className="mb-sm-3 mb-md-0">
          Messages
            ...
            <Documentation
                title="Rounded navs"
                description={
                    <p>If you want the nav style to be rounded, just add the <code>rounded</code> class name to the
                        main <code>&#x3C;Nav.Link&#x3E;</code> component.</p>
                }
                scope={{Nav, Row, Col}}
                imports={`import { Nav } from '@themesberg/react-bootstrap';`}
                example={`<Row>
