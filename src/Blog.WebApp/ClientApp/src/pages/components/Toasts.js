...
import {Button, Card, Col, Container, Row, Toast} from '@themesberg/react-bootstrap';
        ...
        <article>
            <Container className="px-0">
                ...
                <Documentation
                    ...
                    description={
                        <>
                            <p>Use the <code>&#x3C;Toast&#x3E;</code> component to show messages and notifications to
                                the user. The component is split into two main
                                subcomponents: <code>&#x3C;Toast.Header&#x3E;</code> and <code>&#x3C;Toast.Body&#x3E;</code> where
                                you can add the text that you want.</p>
                            <p>You can also use the <code>handleClose</code> function to handle the event of closing the
                                component.</p>
                        </>
                    }
                    scope={{
    ...
    <Toast.Body>
        Hello, world! This is a toast message.
                ...
                <Documentation
                    title="Colors"
                    description={
                        <p>If you'd like to customize the appearance of the <code>&#x3C;Toast&#x3E;</code> component,
                            you can easily do so by adding a <code>bg-primary</code>, <code>bg-secondary</code>, and any
                            other <code>bg-*</code> modifier class to the main <code>&#x3C;Toast&#x3E;</code> component.
                        </p>
                    }
                    scope={{
                        Toast,
