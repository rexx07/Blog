...
import {Button, Col, Container, OverlayTrigger, Row, Tooltip} from '@themesberg/react-bootstrap';
...
export default () => {
        ...
        <article>
            <Container className="px-0">
                ...
                <Documentation
                    title="Example"
                    description={
                        <p>Use the <code>&#x3C;OverlayTrigger&#x3E;</code> and <code>&#x3C;Tooltip&#x3E;</code> to show
                            extra information when hovering or clicking on a given element. Make sure to wrap both the
                            triggering element (ie. a button) and the <code>&#x3C;Tooltip&#x3E;</code> component in
                            a <code>&#x3C;OverlayTrigger&#x3E;</code> component.</p>
                    }
  ...
  <Button variant="secondary" size="sm" className="m-2">Tooltip on top</Button>
                ...
                <Documentation
                    ...
                    description={
                        <p>You can also easily position the <code>&#x3C;Tooltip&#x3E;</code> component in any direction
                            using the <code>placement="*"</code> attribute, where the value can
                            be <code>top</code>, <code>right</code>, <code>bottom</code> or <code>left</code>.</p>
                    }
                    scope={{Button, Tooltip, OverlayTrigger}}
                    imports={`import { Button, Tooltip, OverlayTrigger } from '@themesberg/react-bootstrap';`}
