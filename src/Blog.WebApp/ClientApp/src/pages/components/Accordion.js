    ...
    <article>
        <Container className="px-0">
            ...
            <Documentation
                title="Example"
                description={
                    <p>Use the <code>{`<AccordionComponent>`}</code> component and make sure to set the required props,
                        defaultKey and data, to make it shine. When the title element will be toggled you'll get to see
                        the description.</p>
                }
