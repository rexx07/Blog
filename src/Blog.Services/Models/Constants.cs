...
{
    public static string ConfigSectionKey = "Blog";
    ...
    public static string AvatarDataImage =
        "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 250 250' width='250' " +
        "height='250'%3E%3Crect width='250' height='250' fill='%23622aff'%3E%3C/rect%3E%3Ctext x='50%' y='53%' " +
        "dominant-baseline='middle' text-anchor='middle' font-family='Arial, sans-serif' font-size='128px' " +
        "fill='%23ffffff'%3E{0}%3C/text%3E%3C/svg%3E";
    ...
    public static string ArticleDraft = "D";
    public static string ArticleFeatured = "F";
    public static string ArticlePublished = "P";
